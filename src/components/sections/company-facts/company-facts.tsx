  ...
  return (
    <section className="py-16 bg-background border-t border-b border-border/30">
      <div className="mx-auto max-w-7xl px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-3">Факты о компании</h2>
          <p className="text-muted-foreground">Цифры, которые говорят сами за себя</p>
        </motion.header>
        ...
        <div className="grid gap-8 md:grid-cols-2 max-w-4xl mx-auto">
          {COMPANY_FACTS.map((fact, index) => (
            ...
            >
              <motion.div whileHover={{ scale: 1.1, rotate: 5 }} className="shrink-0 text-primary">
                {fact.icon}
              </motion.div>
