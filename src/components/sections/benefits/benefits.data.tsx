import { Ship, ShieldCheck, Star, Clock, Globe, Award, UserCheck, Heart } from 'lucide-react';
...
export const COMPANY_FACTS: Benefit[] = [
  {
    ...
    description: 'Более 200 маршрутов по всему миру: от Карибов до Антарктиды. Помогаем с визами и трансферами.',
    icon: <Globe className="w-10 h-10" />,
  },
  {
    title: '5+ лет на рынке',
    description: 'Отправили в круизы более 5000 довольных клиентов. Рейтинг 4.9/5 на независимых площадках.',
