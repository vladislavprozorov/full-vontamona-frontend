...
import { contactsSchema, type ContactsFormData } from '@/features/cruiseQuiz/model';
...
export function FooterContactForm() {
  ...
  const { register, handleSubmit, formState: { errors }, setValue, watch } = useForm<ContactsFormData>({
