...
export const metadata: Metadata = {
  ...
  description: 'Полное описание услуг по организации речных и морских круизов. Как мы работаем, что входит в стоимость, наши гарантии.',
  robots: 'index, follow',
};
    ...
    >
      ...
      <section className="mb-12">
        ...
        <div className="space-y-8">
          {servicesContent.services.map((service: { title: string; description: string }, index: number) => (
            <div key={index} className="border-l-4 border-neutral-300 dark:border-neutral-700 pl-6">
      ...
      <section className="mb-12">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {servicesContent.howItWorks.steps.map((step: { number: number; title: string; description: string }) => (
            <div 
              key={step.number}
              className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-6"
            >
