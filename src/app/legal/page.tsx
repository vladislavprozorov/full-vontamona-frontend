...
export const metadata: Metadata = {
  ...
  description:
    "Юридическая информация: политика конфиденциальности, условия договора и оплаты, реквизиты компании, описание услуг.",
  robots: "index, follow",
};
  ...
  return (
    ...
    >
      <div className="grid gap-6 md:grid-cols-2">
        {LEGAL_LINKS.map(
          (doc: { url: string; title: string; version: string; lastUpdated: string }) => (
            <Link
              key={doc.url}
              href={doc.url}
