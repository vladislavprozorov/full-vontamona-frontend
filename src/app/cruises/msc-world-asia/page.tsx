// src/app/cruises/msc-world-asia/page.tsx

import type { Metadata } from "next";
import Image from "next/image";
import Link from "next/link";
import { Header } from "@/components/layout/header/header";
import { type CruiseBadge, mscWorldAsia } from "@/features/cruise-detail";
import { FeedbackForm } from "@/features/feedback/feedback-form";

export const metadata: Metadata = {
  title: mscWorldAsia.seo.title,
  description: mscWorldAsia.seo.description,
};

export default function MscWorldAsiaPage() {
  const cruise = mscWorldAsia;
          ...
          <div className="grid md:grid-cols-2 gap-6 items-stretch">
            <div className="relative rounded-2xl overflow-hidden min-h-[420px]">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <h3 className="text-white font-bold text-2xl">{cruise.region}</h3>
