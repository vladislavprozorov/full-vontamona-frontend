...
import { FeedbackFormValues, feedbackSchema } from "./feedback.schema";
  ...
  if (isSubmitSuccessful) {
    return (
      <div className="py-16 text-center">
        ...
        <p className="mt-2 text-sm text-neutral-500">Персональный менеджер уже получил заявку</p>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 p-10 md:p-14">
        ...
        <div>
          ...
          <p className="mt-4 text-[15px] text-neutral-600 leading-relaxed">
            Подбор круиза под ваши даты, бюджет и пожелания. Один эксперт. Один контакт. Полная
            ответственность.
          </p>
          ...
          <p className="mt-6 text-xs text-neutral-400">Мы не передаём данные третьим лицам</p>
        </div>
