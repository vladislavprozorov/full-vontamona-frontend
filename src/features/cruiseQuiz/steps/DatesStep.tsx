...
interface DatesStepProps {
  ...
  selectingValue?: DateRange | null; // 🔥 Было string | null
}

export const DatesStep = memo(function DatesStep({
  onSelect,
  selectedValue,
  selectingValue,
}: DatesStepProps) {
                ...
                ${
                  isSelecting
                    ...
                    : isSelected
                      ...
                      : "border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-950 shadow-sm hover:border-neutral-300 dark:hover:border-neutral-600 hover:shadow-lg hover:-translate-y-0.5 active:scale-[0.98]"
                }`}
              style={{
            ...
            >
              <div className="flex items-center justify-between">
                ...
                {(isSelected || isSelecting) && (
                  <svg
                    className={`
                    w-5 h-5 transition-all ${isSelecting ? "duration-75" : "duration-200"} ${
                      isSelecting
