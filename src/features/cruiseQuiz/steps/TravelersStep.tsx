...
interface TravelersStepProps {
  ...
  selectingValue?: Travelers | null; // 🔥 Было string | null
}

export const TravelersStep = memo(function TravelersStep({
  onSelect,
  selectedValue,
  selectingValue,
}: TravelersStepProps) {
    ...
    <div className="space-y-4 md:space-y-5">
      <div>
        ...
        <p className="text-sm text-neutral-500 dark:text-neutral-400">
          Это поможет подобрать подходящую атмосферу на борту
        </p>
      </div>
